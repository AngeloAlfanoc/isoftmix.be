...
class Footer extends React.Component {
    ...
    fetch = async(p) => {
        ...
        await axios
            .get(frontConfig.mainRestRef + frontConfig.mainJsonStream + frontConfig.getSecondaryMenuEng)
            .then((result) => {
                    ...
                    return (
                        <li className="d-flex align-items-center" key={i}>
                            <FontAwesomeIcon
                                ...
                                icon={faChevronRight}/>
                            <a className="pl-1" href={'producten/' + item.acf.permalink}>{item.acf.product_name_nl}</a>
                        </li>
                    )
                } else {
                    return ''
    ...
    render() {
        ...
        if (isLoadedMenu0 === true && isLoadedMenu1  === true && isLoadedMenu2  === true && isLoadedMenu3  === true && isLoadedSections  === true) {
            return (
                <footer>
                    <div className="container d-flex flex-row flex-wrap text-white  justify-content-between p-3 py-5">
                    ...
                    <div className="bg-third">
                        <div className="text-white text-center botbar d-flex justify-content-center col-sm-12">
