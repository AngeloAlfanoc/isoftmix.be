        ...
        if (error) {
            ...
            return ( <> <BrowserView>
                <div className="slick-container">
                    <Slider {...settings}>
                        {this.buildSlickDesktop(data.title_eng_1,data.subtitle_eng_1,data.button_eng_1,data.button_1_href_eng)}
                        {this.buildSlickDesktop(data.title_eng_2,data.subtitle_eng_2,data.button_eng_2,data.button_2_href_eng)}
                        {this.buildSlickDesktop(data.title_eng_3,data.subtitle_eng_3,data.button_eng_3,data.button_3_href_eng)}
                    </Slider>
            ...
            <div className="slick-container">
                <Slider {...settings}>
                {this.buildSlickMob(data.title_eng_1,data.subtitle_eng_1,data.button_eng_1,data.button_1_href_eng)}
                {this.buildSlickMob(data.title_eng_2,data.subtitle_eng_2,data.button_eng_2,data.button_2_href_eng)}
                {this.buildSlickMob(data.title_eng_3,data.subtitle_eng_3,data.button_eng_3,data.button_3_href_eng)}
                </Slider>
                <div className="media-wrapper">
