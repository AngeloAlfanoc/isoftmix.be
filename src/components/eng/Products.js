        ...
        if (error) {
            ...
            return <> <section className="products">
                ...
                <ScrollAnimation animateIn="fadeIn" animateOnce={true}>
                        ...
                        <p className="pb-2">
                        Here is an overview of all the products we have available.
                        </p>
            
                        <Slider {...settings}>
                            {data.map((item, i) => {
                                if (item.acf.descr_eng.length > 125) {
                                    item.acf.descr_eng = item
                                        .acf
                                        .descr_eng
                                        .substring(0, 120) + '...'
                                }
                                return (
                                    <div className="mb-3" key={i}>
                                        <div style={{maxHeight: 175 + 'px',wrap}} className="d-flex m-2 mr-3">
                                            <Parallax
                                                className="mr-4 rounded"
                                                bgImage={item.acf.picture}
                                                bgImageAlt="volume of products"
                                                strength={50}>
                                                <div style={{width: 350 + 'px',height: 150 + 'px'}}/>
                                            </Parallax>
                                            <div className="d-flex flex-column justify-content-center">
                                                <h3>
                                                    <a href={this.state.location + item.acf.permalink}>{item.acf.product_name_eng}</a>
                                                </h3>
                                                <p
            ...
            <div className="mt-2 float-right">
                <a
                    ...
                    <small>Complete Overview<FontAwesomeIcon
                        style={{
        fontSize: '1.2em',
        color: '#e7e7e7',
        paddingLeft:'.5em'
