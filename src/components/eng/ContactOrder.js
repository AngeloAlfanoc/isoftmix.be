    ...
    render() {
            return ( <> <div id="contactOrder" className="contact container mt-5">
                <div className="d-flex flex-row align-items-center mt-5">
                    ...
                    <span classnames="anim-title-bounce">
                        <FontAwesomeIcon style={{ fontSize: '1.4em',  color: '#FFBF37' }} icon={faChevronRight}/>
                    </span>
                </div>
                <div>
                    <form onSubmit={this.handleSubmit.bind(this)}method="POST">
                        <input required type="text" className="form-control w-100 my-3" id="name" aria-describedby="nameHelp" value={this.state.user} onChange={this.onUserChange.bind(this)} placeholder="Your name"></input>
                        <input required type="email"  className="form-control  w-100 my-3" id="email" aria-describedby="emailHelp" value={this.state.email} onChange={this.onEmailChange.bind(this)} placeholder="Your email"></input>
                        <input  required placeholder="Chosen Product" type="Product" className="form-control w-100  my-1" id="Product" aria-describedby="ProductHelp" value={this.state.product} onChange={this.onProductChange.bind(this)}/>
                        <textarea required placeholder='Your Message' className="form-control  my-3" rows="2" id="message" value={this.state.message} onChange={this.onMessageChange.bind(this)}/>
