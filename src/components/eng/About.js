...
class About extends React.Component {
    ...
    render() {
        ...
        if (isLoaded === true) {
            if (location === routesObject.routesENG.default) {
                if (data.paragraaf_eng.length > 380) {
                    data.paragraaf_eng = data.paragraaf_eng.substring(0, 375) + '...'
                }
            }
            return ( 
         <>
        <section className="about" style={this.state.location === '/eng' ? { paddingBottom: 100+'px', paddingTop: 100+'px'} : {paddingBottom: 100+'px'}}>
                ...
                <div className="d-flex flex-column align-items-start w-100  pb-5 flex-wrap">
                    ...
                    <div className="d-flex flex-row flex-wrap">
                        ...
                        <div className="col-md-6">
                            <ScrollAnimation animateIn="fadeIn">
                                <p dangerouslySetInnerHTML={{__html:data.paragraaf_eng}}></p>
                                {location === routesObject.routesENG.default? <a href={routesObject.routesENG.about}>Read more</a> : ''}
                            </ScrollAnimation>
                        </div>
