...
class About extends React.Component {
    ...
    render() {
        ...
        if (isLoaded === true) {
            if (location === routesObject.routesDE.default) {
                if (data.paragraaf_de.length > 380) {
                    data.paragraaf_de = data.paragraaf_de.substring(0, 375) + '...'
                }
            }
            return ( 
         <>
        <section className="about" style={this.state.location === '/de' ? { paddingBottom: 100+'px', paddingTop: 100+'px'} : {paddingBottom: 100+'px'}}>
                ...
                <div className="d-flex flex-column align-items-start w-100  pb-5 flex-wrap">
                    ...
                    <div className="d-flex flex-row flex-wrap">
                        ...
                        <div className="col-md-6">
                            <ScrollAnimation animateIn="fadeIn">
                                <p dangerouslySetInnerHTML={{__html:data.paragraaf_de}}></p>
                                {location === routesObject.routesDE.default? <a href={routesObject.routesDE.about}>Weiterlesen</a> : ''}
                            </ScrollAnimation>
                        </div>
