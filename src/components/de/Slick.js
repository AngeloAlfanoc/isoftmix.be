        ...
        if (error) {
            ...
            return ( <> <BrowserView>
                <div className="slick-container">
                    <Slider {...settings}>
                        {this.buildSlickDesktop(data.title_de_1,data.subtitle_de_1,data.button_de_1,data.button_1_href_de)}
                        {this.buildSlickDesktop(data.title_de_2,data.subtitle_de_2,data.button_de_2,data.button_2_href_de)}
                        {this.buildSlickDesktop(data.title_de_3,data.subtitle_de_3,data.button_de_3,data.button_3_href_de)}
                    </Slider>
            ...
            <div className="slick-container">
                <Slider {...settings}>
                {this.buildSlickMob(data.title_de_1,data.subtitle_de_1,data.button_de_1,data.button_1_href_de)}
                {this.buildSlickMob(data.title_de_2,data.subtitle_de_2,data.button_de_2,data.button_2_href_de)}
                {this.buildSlickMob(data.title_de_3,data.subtitle_de_3,data.button_de_3,data.button_3_href_de)}
                </Slider>
                <div className="media-wrapper">
