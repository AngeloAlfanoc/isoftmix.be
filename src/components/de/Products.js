            ...
            return <section className="products">
                ...
                <ScrollAnimation animateIn="fadeIn" animateOnce={true}>
                        ...
                        <p className="pb-2">
                            ...
                            Hier finden Sie eine Übersicht aller verfügbaren Produkte.
                        </p>

                        <Slider {...settings}>
                            {data.map((item, i) => {
                                if (item.acf.descr_de.length > 125) {
                                    item.acf.descr_de = item
                                        .acf
                                        .descr_de
                                        .substring(0, 120) + '...'
                                }
                                    ...
                                    <div className="mb-3" key={i}>
                                        <div style={{ maxWidth: 100 + '%',maxHeight: 75 + '%', wrap }}className="d-flex m-2 mr-3">
                                            ...
                                            <div
                                                ...
                                                <h3>
                                                    <a href={this.state.location + item.acf.permalink}>{item.acf.product_name_de}</a>
                                                </h3>
                                                <p
                                                    style={{
                                                    minHeight: 85 + 'px'
                    ...
                    <div className="mt-2 float-right">
                        <a
                            ...
                            <small>Komplette Übersicht<FontAwesomeIcon
                                style={{
                fontSize: '1.2em',
                color: '#e7e7e7',
                paddingLeft:'.5em'
