                ...
                <ScrollAnimation animateIn="fadeIn">
                    <div id="contact" className="container py-5">
                        <div className="d-flex flex-row align-items-center">
                            ...
                            <span className="mr-3">
                                <a href={routesObject.routesDE.contact}>
                                    <h2>Kontakt</h2>
                                </a>
                            </span>
                            <span className="mr-3 anim-title-bounce">
                                <a href={routesObject.routesDE.contact}><FontAwesomeIcon
                                    style={{
                fontSize: '1.8em',
                color: '#FFBF37'
            }}
                        ...
                        <form
                            ...
                            <div className="d-flex flex-row justify-content-between my-4">
                                ...
                                <input
                                    ...
                                    .onEmailChange
                                    .bind(this)}
                                    placeholder="Deine E-Mail"></input>
                            </div>
                            <div>
                                <input
