        ...
        if (error) {
            ...
            return ( <> <BrowserView>
                <div className="slick-container">
                    <Slider {...settings}>
                        {this.buildSlickDesktop(data.title_nl_3,data.subtitle_nl_3,data.button_nl_3,data.button_3_href_nl)}
                        {this.buildSlickDesktop(data.title_nl_1,data.subtitle_nl_1,data.button_nl_1,data.button_1_href_nl)}
                        {this.buildSlickDesktop(data.title_nl_2,data.subtitle_nl_2,data.button_nl_2,data.button_2_href_nl)}
            ...
            <div className="slick-container">
                <Slider {...settings}>
                {this.buildSlickMob(data.title_nl_3,data.subtitle_nl_3,data.button_nl_3,data.button_3_href_nl)}
                {this.buildSlickMob(data.title_nl_1,data.subtitle_nl_1,data.button_nl_1,data.button_1_href_nl)}
                {this.buildSlickMob(data.title_nl_2,data.subtitle_nl_2,data.button_nl_2,data.button_2_href_nl)}
