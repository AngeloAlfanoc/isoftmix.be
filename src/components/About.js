...
class About extends React.Component {
    ...
    render() {
        ...
        if (isLoaded === true) {
            if (location === '/') {
                if (data.paragraaf_nl.length > 380) {
                    data.paragraaf_nl = data.paragraaf_nl.substring(0, 375) + '...'
                }
            }
            return ( <> <section
                className="about"
                ...
                color: '#FFBF37'
                        ...
                        <div className="d-flex flex-row flex-wrap">
                            <div className="col-md-6">
                                <ScrollAnimation animateIn="fadeIn" animateOnce={true}>
                                    <p dangerouslySetInnerHTML={{ __html: data.paragraaf_nl}}></p>
                                    {location === '/' ? <a href={routesObject.routesNL.about}>Lees meer</a> : ''}
                                </ScrollAnimation>
                            </div>
                            <div className="col-md-6">
                                <ScrollAnimation animateIn="fadeIn" animateOnce={true}>
