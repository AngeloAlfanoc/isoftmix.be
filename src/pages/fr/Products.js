...
import ContactOrder from '../../components/fr/ContactOrder'
    ...
    render() {
        ...
        if (error) {
            ...
            return <div className="products loaded">
                <Helmet>
                    <title>{"iSOFTMIX.be - "+dataText.title_producten_fr}</title>
                </Helmet>
                <Header/>
                <Breadcrumbs/>
                <section>
                    <div className="container">
                        <div className="d-flex flex-row align-items-center">
                            <span className="mr-3">
                                <h2>{dataText.title_producten_fr}</h2>
                            </span>
                            <span>
                                <FontAwesomeIcon
                                    style={{
                        ...
                        <p
                            ...
                            __html: dataText.paragraaf_pruducten_fr
                        }}></p>
                    </div>
                    <BrowserView>
                        <div className="container">
                            <div className="row">
                                {data.map((product, i) => {
                                    ...
                                    if (product.acf.descr_fr.length > 180) {
                                        product.acf.descr_fr = product
                                            .acf
                                            .descr_fr
                                            .substring(0, 175) + '...'
                                    }
                                    return (
                                        <div key={i} className="col-lg-6 col-md-12 col-sm-12  my-1  d-flex  rounded">
                                            <div
                                                ...
                                                <div>
                                                    <h3>
                                                        <a href={this.state.location + product.acf.permalink}>{product.acf.product_name_fr}</a>
                                                    </h3>
                                                    <p
                                                        className="d-flex flex-column "
                                                        dangerouslySetInnerHTML={{
                                                        __html: product.acf.descr_fr
                                                    }}></p>
