        ...
        if (isLoadedMenu0 === true && isLoadedMenu1 === true && isLoadedMenu2 === true && isLoadedMenu3 === true) {
            return (
                <div className="loaded">
                    <Helmet>
                        <title>{"iSOFTMIX.be - Plan du site"}</title>
                    </Helmet>
                    <Header/>
                    <div className="container p-5">
                        ...
                        <p>
                            Vous trouverez ici un aperçu de tous les liens disponibles sur cette page.</p>
                        <div className="d-flex flex-wrap w-100 justify-content-around">
                            <div className="col-lg-3 py-1">
                                <h5>
                                    Menu principal</h5>{this.buildListedItems(menu0)}</div>
                            <div className="col-lg-3 py-1">
                                <h5>
                                    Eléments supplémentaires</h5>{this.buildListedItems(menu1)}</div>
                            <div className="col-lg-3 py-1">
                                <h5>
                                    Liens sociaux</h5>{this.buildListedItems(menu2)}</div>
                            <div className="col-lg-3 py-1">
                                <h5>
                                    Des produits</h5>{this.buildProductMenu(menu3)}</div>
                        </div>
                    </div>
                    <Footer/>
                </div>
