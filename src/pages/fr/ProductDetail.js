...
import TechTable from '../../components/fr/TechTable'
        ...
        if (isLoaded === true) {
            ...
            return p.map((item, i) => {
                ...
                if (location === productNeeded) {
                    ...
                    let sanitizeSEOTAG = item.acf.descr_fr.replace(/(<([^>]+)>)/ig,"");
                    return (<>
                            ...
                            <div  className={isMobile? "d-flex flex-row flex-wrap mb-3" : "d-flex flex-row mb-3" }>
                                ...
                                <p className={isMobile? "mt-2":""}
                                    ...
                                    <div className="d-flex flex-column align-items-end">
                                        <span className="my-4">Prix ​​visé €{item.acf.richtprijs_},00</span>
                                        <div
